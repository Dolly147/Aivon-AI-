        ...
        <main className="main">
            ...
            <div className="main-container">
                ...
                {!showResult
                    ? <>
                        <div className="greet">
                           <p><span>Hello, Keerthi 👋</span></p>
<p className="subtext">Ask me anything — coding, ideas, or learning 🚀</p>
  ...
  if (e.key === 'Enter' && !e.shiftKey) {
    ...
    onSent();
                    ...
                    <p className="bottom-info">
                        Aivon may display inaccurate info, including about people, so double-check its responses.
                        <a href="#">Your privacy and Aivon Apps</a>
                    </p>
                </div>
            </div>
        </main>
